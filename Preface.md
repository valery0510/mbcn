...
##代码示例
本书示例是基于类Unix操作系统（例如Linux或Mac OS X）的命令行，用Python，C++编程语言来说明的。全部代码段均可在[Github主代码库](https://github.com/aantonop/bitcoinbook)中的code子目录获得。读者可以通过GitHub创建自己的代码分支，尝试书中示例，或者提交代码更正。
...
本书某些版本提供了开源许可，如[CC-BY-NC](http://creativecommons.org)，这种情况下,开源许可条款适用。
